...
def train(data_root):
    ...
    train_dir = os.path.join(data_root, "train") if os.path.isdir(os.path.join(data_root, "train")) else data_root
    val_dir   = os.path.join(data_root, "val")   if os.path.isdir(os.path.join(data_root, "val"))   else None

    train_ds = ColorDataset(train_dir, transform=train_tfm)
    if val_dir:
        val_ds = ColorDataset(val_dir, transform=val_tfm)
